...
CREATE TABLE IF NOT EXISTS `contact` (
                                         ...
                                         CONSTRAINT `fk_contact_target` FOREIGN KEY (`id_target_user`) REFERENCES `user` (`id_user`),
...
CREATE TABLE IF NOT EXISTS `transaction` (
                                             ...
                                             CONSTRAINT `fk_trans_card` FOREIGN KEY (`id_source_card`) REFERENCES `payment_card` (`id_card`),
                                             CONSTRAINT `fk_trans_caregiver` FOREIGN KEY (`id_validator_caregiver`) REFERENCES `caregiver` (`id_caregiver`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
